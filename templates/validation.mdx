...
<Note>
  ...
  quantidade) está declarado no schema de [Criar template](/templates/create-template):
...
As respostas rápidas vêm **todas primeiro**, e os demais botões depois. A Meta
recusa quando a ordem mistura os dois grupos.
...
autenticação, **o texto do botão é da Meta**. Se você mandar outro, ela recusa
dizendo qual é o certo (código `2388153`), então mande o dela ou omita o campo.
