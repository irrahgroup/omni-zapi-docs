...
<Warning>
  **Localização e contato não existem** no Messenger. O botão de localização foi descontinuado pela Meta em outubro de 2019. Veja [o que cada canal aceita](/channels/message-support).
</Warning>
