...
<Note>
  As regras que a Meta valida (formato do ID da tela, nome dos campos, navegação e tela final) estão em [Componentes e regras](/flows/components). São elas que reprovam a publicação.
</Note>
