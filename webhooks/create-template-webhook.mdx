...
A assinatura chega no header `x-webhook-signature` e é calculada sobre uma string canônica de cinco campos — não apenas sobre o corpo. Veja [Assinatura HMAC](/webhooks/signature).
