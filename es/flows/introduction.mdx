...
<Note>
  Las reglas que Meta valida (formato del ID de la pantalla, nombre de los campos, navegación y pantalla final) están en [Componentes y reglas](/es/flows/components). Son las que impiden la publicación.
</Note>
