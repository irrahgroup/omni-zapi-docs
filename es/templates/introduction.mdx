...
<Warning>
  **Los tres canales de Meta tienen plantilla preaprobada**: Meta Cloud API, Instagram y Messenger. Lo que cambia es el alcance, el endpoint y la categoría.

  Hoy los endpoints de esta sección cubren **solo Meta Cloud API** (alcance WABA). La compatibilidad con Instagram y Messenger está **en implementación**.
</Warning>
...
|---|---|---|---|
| Canales | Meta Cloud API | **Messenger** | Instagram, Messenger, WhatsApp |
...
<Note>
  Consulta [qué acepta cada canal](/es/channels/message-support) para ver qué admite cada canal.
</Note>
...
<Note>
  Antes de elegir la categoría, consulta los [modelos de plantilla](/es/templates/models/overview): el tipo define qué campos existen, y algunos vienen con categoría fija.
</Note>
