...
La firma llega en el header `x-webhook-signature` y se calcula sobre una cadena canónica de cinco campos, no solo sobre el cuerpo. Consulta [Firma HMAC](/es/webhooks/signature).
