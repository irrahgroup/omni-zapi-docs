...
<Note>
  ...
  types, counts) is declared in the [Create template](/en/templates/create-template)
...
Quick replies come **all first**, and the remaining buttons after them. Meta
rejects the template when the order mixes the two groups.
