...
<Warning>
  **All three Meta channels have pre-approved templates**: Meta Cloud API, Instagram and Messenger. What changes is the scope, the endpoint and the category.

  Today the endpoints in this section cover **Meta Cloud API only** (WABA scope). Instagram and Messenger support is **being implemented**.
</Warning>
...
|---|---|---|---|
| Channels | Meta Cloud API | **Messenger** | Instagram, Messenger, WhatsApp |
...
<Note>
  See [what each channel accepts](/en/channels/message-support).
</Note>
...
<Note>
  Before picking the category, see the [template models](/en/templates/models/overview): the type defines which fields exist, and some come with a fixed category.
</Note>
