...
<Note>
  The `channelId` and the [messages](/en/messages/introduction) and [webhooks](/en/webhooks/introduction) endpoints work the same for every type. What changes is the connection flow and, for Meta Cloud API, the [24-hour window](/en/conversation-window).
</Note>
