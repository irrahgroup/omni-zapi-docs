...
The signature arrives in the `x-webhook-signature` header and is computed over a canonical string of five fields — not over the body alone. See [HMAC signing](/en/webhooks/signature).
