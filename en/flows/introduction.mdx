...
<Note>
  The rules Meta validates (screen ID format, field names, navigation and the terminal screen) are in [Components and rules](/en/flows/components). Those are what block publication.
</Note>
