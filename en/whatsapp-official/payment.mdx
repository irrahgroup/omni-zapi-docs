---
title: "Payment"
description: "Set up a payment method to send message templates through the Meta Cloud API API"
---
...
To use the **Meta Cloud API API**, you need to set up a payment method. This setup enables you to send **message templates**.
