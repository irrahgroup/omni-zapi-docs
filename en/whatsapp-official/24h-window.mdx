...
description: "Understand how the Meta Cloud API API's 24-hour window works and when to use templates"
---
...
The 24-hour window is a rule of the **Meta Cloud API API** defined by Meta to control when a business can chat freely with a customer and when it's necessary to use **message templates (templates)**.
