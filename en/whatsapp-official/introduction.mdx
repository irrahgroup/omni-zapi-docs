---
title: "Introduction"
description: "Key Meta concepts for understanding and using the Meta Cloud API API"
---
...
In this documentation, you'll find the key Meta concepts for understanding how the **Meta Cloud API API** works, connecting your numbers, and making the most of {projectName}'s features.
