...
**Coexistence** mode allows you to connect a number that is already in use in the **WhatsApp Business** app to the **Meta Cloud API API**, while keeping the conversation history and the ability to keep using the app in parallel.
