...
<Warning>
  **Location and contact do not exist** on Instagram. The platform has no such message types — the call will not work. See [what each channel accepts](/en/channels/message-support).
</Warning>
